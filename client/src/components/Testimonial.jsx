    ...
    const cardsData = [
        {
            ...
            handle: '@sarahtravels',
            date: 'March 15, 2025',
            testimonial: 'Amazing experience! The BMW X5 was spotless and drove like a dream. Perfect for our family vacation to the mountains.'
        },
        {
            ...
            handle: '@marcusdrives',
            date: 'April 2, 2025',
            testimonial: 'Great service and competitive prices! The pickup process was smooth and the Toyota Corolla was exactly what I needed for my business trip.'
        },
        {
            ...
            date: 'April 18, 2025',
            testimonial: 'Booked last minute and they delivered! The Jeep Wrangler was perfect for our off-road adventure. Will definitely rent again!'
        },
        {
            image: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?q=80&w=200',
            name: 'David Chen',
            handle: '@davidontheroad',
            date: 'May 5, 2025',
            testimonial: 'Outstanding customer service! Had an issue with my reservation and they sorted it out immediately. The car was immaculate.'
        },
        {
            ...
            date: 'May 20, 2025',
            testimonial: 'Reliable and trustworthy service. The car was delivered on time and in perfect condition. Highly recommend for anyone needing a rental!'
        }
    ];
    ...
    return (
        ...
        `}</style>
            <div className='flex flex-col items-center justify-center'>
                <Title title="Testimonials" subTitle="What our customers say" align="left"/>
            </div>
