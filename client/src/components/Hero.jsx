...
const Hero = () => {
  ...
  return (
    ...
    bg-light text-center'>
        <h1 className='text-4ml md:text-5xl font-semibold'>Luxury cars on rent</h1>
        ...
        md:max-w-200 bg-white shadow-[0px_8px_20px_rbga(0,0,0,0.1)]'>
            ...
            gap-10 min-md:ml-8'>
                ...
                <div className='flex flex-col items-start gap-2'>
                    ...
                    required className='text-sm text-gray-500'
                    />
                </div>
                <div className='flex flex-col items-start gap-2'>
